	...
	$.getJSON(Url, function (json) {
		if(json.message != "fail"){
			$("head").append(popupStyle);
					...
					"<span class='lafa-notification-close'id='close' onclick='this.parentNode.parentNode.removeChild(this.parentNode); return false;'>x</span><table><tbody><tr>" +
